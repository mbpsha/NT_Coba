    ...
    <div class="relative min-h-screen overflow-hidden">
        ...
        <div class="relative z-10 flex justify-center px-4">
            <div class="w-full max-w-md p-8 shadow-lg rounded-xl" style="background-color: #BCD6B1;">
                <h1 class="mb-8 text-2xl font-semibold text-center text-white">Create Your Account</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        ...
                        />
                        <div v-if="form.errors.username" class="mt-1 text-sm text-red-200">{{ form.errors.username }}</div>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-white">E-mail</label>
                        <input
                            v-model="form.email"
                            type="email"
                            required
                        ...
                        />
                        <div v-if="form.errors.email" class="mt-1 text-sm text-red-200">{{ form.errors.email }}</div>
                    </div>
                    <div>
                        ...
                        />
                        <div v-if="form.errors.nama" class="mt-1 text-sm text-red-200">{{ form.errors.nama }}</div>
                    </div>
