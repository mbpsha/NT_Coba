        ...
        <main class="ml-64 pt-16 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ stats?.totalProducts || 0 }}</h3>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ stats?.totalUsers || 0 }}</h3>
                        </div>
                        <div class="bg-green-100 p-3 rounded-full">
                            <svg class="w-8 h-8 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ stats?.totalOrders || 0 }}</h3>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm uppercase">Pending Verification</p>
                            <h3 class="text-3xl font-bold text-gray-800 mt-1">{{ stats?.pendingPayments || 0 }}</h3>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a :href="route('admin.products.index')" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 text-sm">
                            View All
                        </a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead>
                                <tr class="border-b">
                                    <th class="text-left py-3 px-2 text-gray-600 font-semibold">Name</th>
                            ...
                            <tbody>
                                <tr v-for="product in recentProducts" :key="product.id" class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-2">{{ product.nama_produk }}</td>
                                    <td class="py-3 px-2">Rp {{ product.harga?.toLocaleString('id-ID') }}</td>
                                    <td class="py-3 px-2">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a :href="route('admin.users.index')" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 text-sm">
                            View All
                        </a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead>
                                <tr class="border-b">
                                    ...
                                    <th class="text-left py-3 px-2 text-gray-600 font-semibold">Role</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="user in recentUsers" :key="user.id" class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-2">{{ user.nama }}</td>
            ...
            <!-- Monthly Sales Chart -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Monthly Sales Overview</h2>
                <div class="h-64 flex items-end justify-between gap-2">
                    <div v-for="(sale, index) in monthlySales" :key="index" class="flex-1 flex flex-col items-center">
                        ...
                        <span class="text-xs text-gray-600 mt-2">{{ sale.month }}</span>
                    </div>
                </div>
