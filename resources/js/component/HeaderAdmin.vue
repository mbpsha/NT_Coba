...
<template>
  <header class="fixed top-0 right-0 left-64 h-16 bg-gradient-to-r from-green-400 to-green-500 shadow-md z-10">
    <div class="flex items-center justify-between h-full px-8">
      ...
      <div class="flex items-center gap-4 text-white">
        ...
        <!-- tombol logout -->
        <button @click="onLogout" class="px-3 py-1.5 rounded-md bg-white/20 hover:bg-white/30 text-white text-sm">
          Log-out
        </button>
      </div>
    </div>
